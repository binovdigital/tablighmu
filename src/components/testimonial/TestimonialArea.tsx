									...
									<div className="card-body">
										<div className="single-testimonial-slide">
											<div className="image-wrapper shadow">
												<Image width={80} height={80} src="/assets/img/bg-img/20.jpg" alt="" />
											</div>
							...
							<SwiperSlide>
								<div className="card">
									<div className="card-body">
										<div className="single-testimonial-slide">
											<div className="image-wrapper shadow">
												<Image width={80} height={80} src="/assets/img/bg-img/21.jpg" alt="" />
											</div>
											<div className="text-content">
												<p className="mb-2">
						...
						<div className="card-body p-0">
							<div className="testimonial-slide-two-wrapper">
								...
								>
									...
									<SwiperSlide className="single-testimonial-slide">
										<div className="image-wrapper shadow-sm">
											<Image width={100} height={40} src="/assets/img/bg-img/20.jpg" alt="" />
											<i className="bi bi-chat-quote"></i>
										</div>
										<div className="text-content">
											<p className="mb-0">
