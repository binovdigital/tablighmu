...
const PartnerLogoTwo = () => {
	return (
		<>
			<div className="container">
				<div className="card bg-info">
					<div className="card-body">
						<div className="partner-logo-slide-wrapper-2">
							<Swiper
								slidesPerView={3}
								loop={true}
								spaceBetween={15}
									...
									<SwiperSlide key={i}>
										<div className="card partner-slide-card border my-2 bg-white">
											<div className="card-body p-3">
												<a href="#">
													<Image width={160} height={70} style={{objectFit: 'cover', height: 'auto'}} src={item} alt="" />
												</a>
											</div>
										</div>
									</SwiperSlide>
