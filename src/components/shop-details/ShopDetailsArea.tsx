									...
									{image_data.map((image, index) => (
										<SwiperSlide key={index}>
											<a
												...
												data-gall="gallery2"
											>
												<Image width={688} height={688} className="rounded" src={image.img} alt="" />
											</a>
										</SwiperSlide>
									))}
								</Swiper>
									...
									<div className="card single-product-card border">
										<div className="card-body p-3">
											...
											<Link
												...
												href="/shop-details"
											>
												<Image width={126} height={126} src="/assets/img/bg-img/p1.jpg" alt="" />
												{/* <!-- Badge --> */}
									...
									<div className="card single-product-card border">
										<div className="card-body p-3">
											...
											<Link
												...
												href="/shop-details"
											>
												<Image width={126} height={126} src="/assets/img/bg-img/p2.jpg" alt="" />
												{/* <!-- Badge --> */}
												<span className="badge bg-primary">Sale</span>
											</Link>
											{/* <!-- Product Title --> */}
