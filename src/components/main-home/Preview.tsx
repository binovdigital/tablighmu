					...
					<div className="row g-2 align-items-center justify-content-between">
						<div className="col-12 col-lg-3">
							...
							<ul className="demo-desc ps-0 mb-5">
								...
								<li>
									<i className="bi bi-check-lg"></i> App Directory v 15.4.1
								</li>
								<li>
									<i className="bi bi-check-lg"></i> PWA Ready
								</li>
								<li>
									<i className="bi bi-check-lg"></i> Bootstrap 5.3.7
								</li>
								<li>
						...
						<div className="col-12 col-lg-3">
							<div className="text-lg-end">
								...
								<div className="qr-code-wrapper shadow border">
									<Image width={241} height={241} src="/assets/img/demo-img/qr-code.png" alt="" />
									<h6 className="mb-0">
